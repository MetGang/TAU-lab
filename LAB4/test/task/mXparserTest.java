...
public class mXparserTest
{
	...
	public void test_3()
	{
		...
		when(exp.calculate()).thenReturn(2.0);
		
		assertEquals(2.0, exp.calculate());
	}
	...
	public void test_4()
	{
		...
		when(exp.checkSyntax()).thenReturn(true);
		
		assertTrue(exp.checkSyntax());
	}
	...
	public void test_5()
	{
		...
		when(exp.getErrorMessage()).thenReturn("Bad syntax");
		
		assertEquals("Bad syntax", exp.getErrorMessage());
	}
}
